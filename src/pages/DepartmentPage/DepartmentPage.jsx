    ...
    return(
        <>
            ...
            {department?.field_image?.[0]?.target_id &&(
                <img src={department?.field_image?.[0]?.url} alt={department?.field_image?.[0]?.alt}/>
            )}
            ...
            <div className={"social_media"}>
                {department?.field_social_media?.[0]?.platform_values?.facebook?.value && (
                    <Link to={`https://www.facebook.com/${department?.field_social_media?.[0]?.platform_values?.facebook?.value}`}>
                ...
                {department?.field_social_media?.[0]?.platform_values?.twitter?.value &&(
                    <Link to={`https://www.twitter.com/${department?.field_social_media?.[0]?.platform_values?.twitter?.value}`}>
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"/></svg>
                    </Link>
                )}
                {department?.field_social_media?.[0]?.platform_values?.instagram?.value &&(
                    <Link to={`https://www.instagram.com/${department?.field_social_media?.[0]?.platform_values?.instagram?.value}`}>
