...
import OnlineUsersCounter from "./OnlineUsersCounter.jsx";
...
const Footer = () => {
    ...
    return (
        <div>
            <div>{(langPrefix === 'en' && "Date: ") || "Дата: "}{formattedDate} {(langPrefix === 'en' && "Time: ")|| "Час: "}{formattedTime}<OnlineUsersCounter /></div>
